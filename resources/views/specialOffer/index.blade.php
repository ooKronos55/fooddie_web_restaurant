            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{trans('lang.specialoffer_list')}}</li>
            ...
            <div class="card">
                            <div class="card-header">
                                <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                                    <li class="nav-item">
                                      <a class="nav-link active" href="{!! route('specialOffer') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.specialoffer_list')}}</a>
                                    </li>                                  
                              </ul>
                            </div>
                            <div class="card-body">
...
<div class="form-group col-12 text-center btm-btn">
          <button type="button" class="btn btn-primary  save_special_offer_btn" ><i class="fa fa-save"></i> {{trans('lang.save')}}</button>
