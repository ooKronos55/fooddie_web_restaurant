	...
	<div class="row page-titles">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div id="user_restaurant_set_option" style="display:none" class="form-group row">
							<label class="col-3 control-label">{{trans('lang.restaurant')}}</label>
						<select id="vendor_restaurant_select" class="col-9 form-control"></select>
					</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="form-group row" id="user_restaurant_name"></div>
...
if(user.role == "vendor"){
  ...
  if(snapshots.docs.length >0){
        ...
        $("#user_restaurant_name").append('<label class="col-3 control-label">{{trans('lang.restaurant')}}</label><input type="text" class="col-7 form-control vendor_restaurant" value="'+data.title+'">');
          

  }else{

    $("#user_restaurant_name").append('<label class="col-3 control-label">{{trans('lang.restaurant')}}</label><input type="text" class="col-7 form-control vendor_restaurant" >');
  }
